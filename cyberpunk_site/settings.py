...
# Consider using environment variables for this in production.
...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True, # Looks for templates in app-level 'templates' directories (e.g., market/templates/)
        'OPTIONS': {
            'context_processors': [
...
# This is where your web server (e.g., PythonAnywhere) should serve static files from.
STATIC_ROOT = BASE_DIR / 'staticfiles' # Common convention

# Additional locations of static files (development)
# Django will also look for static files in these directories.
STATICFILES_DIRS = [
